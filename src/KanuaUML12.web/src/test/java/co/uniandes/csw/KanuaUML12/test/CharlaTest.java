...
public void testbarra()
{
    ...
    public void testCreateEquipo() throws Exception {
        ...
        driver.get(baseUrl+"/KanuaUML12.web/charlaMaster.html");
      //  driver.findElement(By.linkText("Proyectos")).click();
        /**
         ...
         */
        driver.findElement(By.id("name")).sendKeys("Charla1");
        driver.findElement(By.id("titulo")).clear();
        driver.findElement(By.id("titulo")).sendKeys("empresas");
        driver.findElement(By.id("informacion")).clear();
        driver.findElement(By.id("informacion")).sendKeys("una charla de emprendimiento");
        
        driver.findElement(By.id("link")).clear();
        driver.findElement(By.id("link")).sendKeys("http://imagen");
        driver.findElement(By.id("imagen")).clear();
        driver.findElement(By.id("imagen")).sendKeys("img");
       
        driver.findElement(By.linkText("Tag_charla")).click();
         Thread.sleep(2000);
          Thread.sleep(2000);
           Thread.sleep(2000);
    ...
    @Test
         ...
         * con el String de parámetro sobre // el elemento encontrado.
         */
        driver.findElement(By.id("name")).sendKeys("Charla111");
        driver.findElement(By.id("titulo")).clear();
        driver.findElement(By.id("titulo")).sendKeys("empresas2");
        driver.findElement(By.id("informacion")).clear();
        driver.findElement(By.id("informacion")).sendKeys("una charla de emprendimiento11");
       ...
       driver.findElement(By.id("name")).clear();
         ...
         * con el String de parámetro sobre // el elemento encontrado.
         */
        driver.findElement(By.id("name")).sendKeys("Charla2");
        driver.findElement(By.id("titulo")).clear();
        driver.findElement(By.id("titulo")).sendKeys("liderazgo");
        driver.findElement(By.id("informacion")).clear();
        driver.findElement(By.id("informacion")).sendKeys("una charla de liderazgo");
