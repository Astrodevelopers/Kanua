...
public void testbarra()
{
    ...
    public void testCreateEquipo() throws Exception {
      ...
      //  driver.findElement(By.linkText("Proyectos")).click();
        ...
        driver.findElement(By.id("titulo")).sendKeys("Empresarios al limite");
        ...
        driver.findElement(By.linkText("Tag_noticia")).click();
         Thread.sleep(2000);
          Thread.sleep(2000);
           Thread.sleep(2000);
    ...
    @Test
         ...
         * con el String de parámetro sobre // el elemento encontrado.
         */
        driver.findElement(By.id("name")).sendKeys("noticia editado");
        driver.findElement(By.id("tema")).clear();
        driver.findElement(By.id("tema")).sendKeys("empresa editada");
        driver.findElement(By.id("titulo")).clear();
        driver.findElement(By.id("titulo")).sendKeys("Empresarios al limite editada");
        ...
        driver.findElement(By.id("descripcion")).clear();
        driver.findElement(By.id("descripcion")).sendKeys("noticia editado");
            ...
            for (WebElement webElement : table) {
                ...
                if (elems.get(0).getText().equals("noticia editada")) {
                    fail = true;
                }
         ...
         * con el String de parámetro sobre // el elemento encontrado.
         */
        driver.findElement(By.id("name")).sendKeys("noticia22");
        driver.findElement(By.id("tema")).clear();
        driver.findElement(By.id("tema")).sendKeys("empresarios");
        driver.findElement(By.id("titulo")).clear();
        driver.findElement(By.id("titulo")).sendKeys("Como ser exitoso");
        ...
        driver.findElement(By.id("descripcion")).clear();
        driver.findElement(By.id("descripcion")).sendKeys("un proyecto para la vida");
        driver.findElement(By.linkText("Tag_noticia")).click();
         Thread.sleep(2000);
          Thread.sleep(2000);
           Thread.sleep(2000);
        ...
        public void testTags() throws Exception{
            driver.get(baseUrl+"/KanuaUML12.web/noticiaMaster.html");
            driver.findElement(By.id("titulobusquedaNoticia")).sendKeys("bla");
               Thread.sleep(10000);
            driver.findElement(By.id("tagNoticiabusqueda")).click();
        }
        @Test
